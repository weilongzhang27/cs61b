...
public class ArrayHeapMinPQTest {
    ...
    public void testInitialization() {
        ArrayHeapMinPQ<Integer> temp = new ArrayHeapMinPQ<Integer>(10);
        ArrayHeapMinPQ<Integer> temp2 = new ArrayHeapMinPQ<Integer>();
    }

    @Test
    public void testResizeUp() {
        ArrayHeapMinPQ<Integer> temp = new ArrayHeapMinPQ<Integer>();
        for (int i = 10; i > 0; i--) {
            temp.add(i, i);
        }
    ...
    public void testGetSmall() {
        ...
        temp.removeSmallest();
        assertEquals(3, (int) temp.getSmallest());
        temp.removeSmallest();
        assertEquals(4, (int) temp.getSmallest());
        temp.removeSmallest();
